...
public class SmartDashboardSS extends Subsystem {
    ...
    public void smartDashboardOutputs() {
		...
		SmartDashboard.putNumber("The Right Range Finder is seeing", RobotMap.rangeFrontRight.getVoltage()/.009765);
		SmartDashboard.putNumber("The Center Range Finder is seeing", RobotMap.rangeBack.getVoltage()/.009765);
		...
		SmartDashboard.putNumber("The Center Range Finder is seeing an average range of", RobotMap.rangeBack.getAverageVoltage()/.009765);
		//Gyro
